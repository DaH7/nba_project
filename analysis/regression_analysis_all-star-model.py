...
# X = df[['PTS','MP','GS','AST','TRB','BLK','PTS percentile group','AST percentile group','TRB percentile group','STL percentile group','BLK percentile group','TOV percentile group',
#         'won MVP', 'won DPOY',]].copy()

X = df[['PTS','MP','GS','AST','PF','TRB','BLK']].copy()
